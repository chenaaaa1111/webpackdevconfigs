...
!function(t, e) {
        ...
        if (n.state === t) {
            ...
            try {
                ...
                if (null !== e && "object" == typeof e && "function" == typeof r)
                    return void r.call(e, function(t) {
                        o || n.resolve(t),
                        o = !0
                    }, function(t) {
                        o || n.reject(t),
            ...
            expand: function(t) {
                return o.replace(/\{([^{}]+)\}|([^{}]+)/g, function(e, n, o) {
                    if (n) {
                        var s = null
                          , u = [];
                        if (-1 !== r.indexOf(n.charAt(0)) && (s = n.charAt(0),
                        n = n.substr(1)),
    ...
    $.params = function(t) {
        ...
        function t(e, n, o) {
            ...
            g(n, function(n, u) {
                r = m(n) || h(n),
                o && (u = o + "[" + (s || r ? u : "") + "]"),
                !o && i ? e.add(n.name, n.value) : r ? t(e, n, u) : e.add(u, n)
            })
        }(e, t),
        e.join("&").replace(/%20/g, "+")
    }
    ...
    function A(t) {
        return new o(function(e) {
            var n, o, r = t.jsonp || "callback", i = t.jsonpCallback || "_jsonp" + Math.random().toString(36).substr(2), s = null;
            n = function(n) {
                var r = n.type
                  , u = 0;
                "load" === r && null !== s ? u = 200 : "error" === r && (u = 500),
                u && window[i] && (delete window[i],
            ...
            (o = document.createElement("script")).src = t.getUrl(),
    ...
    function S(t) {
        return new o(function(e) {
            ...
            l(t.progress) && "GET" === t.method && n.addEventListener("progress", t.progress),
            l(t.downloadProgress) && n.addEventListener("progress", t.downloadProgress),
            l(t.progress) && /^(POST|PUT)$/i.test(t.method) && n.upload.addEventListener("progress", t.progress),
            l(t.uploadProgress) && n.upload && n.upload.addEventListener("progress", t.uploadProgress),
    ...
    var H = function(t, e) {
        ...
        this.status = a || 0,
        this.statusText = c || "",
        this.headers = new L(u),
        this.body = t,
        d(t) ? this.bodyText = t : (i = t,
        "undefined" != typeof Blob && i instanceof Blob && (this.bodyBlob = t,
        (0 === (r = t).type.indexOf("text") || -1 !== r.type.indexOf("json")) && (this.bodyText = (n = t,
        new o(function(t) {
    ...
    function N(t) {
            ...
            function r(r) {
                for (; e.length; ) {
                    ...
                    if (l(i)) {
                        ...
                        c = "Invalid interceptor of type " + typeof i + ", must be a function",
                        "undefined" != typeof console && a && console.warn("[VueResource warn]: " + c)
                }
                var c
            }
            return m(t) || (t = null),
        ...
        }(t || {}, e.$options, N.options),
        N.interceptors.forEach(function(t) {
            d(t) && (t = N.interceptor[t]),
            l(t) && n.use(t)
        }),
    ...
    N.interceptors = ["before", "method", "jsonp", "json", "form", "header", "cors"],
